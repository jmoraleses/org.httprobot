 ...
 *
 */
public interface IEndIndexListener extends IRmlListener
{

	/**
	 * When {@link EndIndex} {@link Rml} has been read.
	 ...
	 * @throws InconsistenMessageException when message data doesn't match with corresponding controller.	 
	 */
	public void OnEndIndexLoaded(Object sender, RmlEventArgs e) throws NotImplementedException, InconsistenMessageException;
	 ...
	 * @throws InconsistenMessageException when message data doesn't match with corresponding controller.	 
	 */
	public void OnEndIndexRendered(Object sender, RmlEventArgs e) throws NotImplementedException, InconsistenMessageException;
