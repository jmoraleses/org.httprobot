...
public class CliTools 
{
	...
	public static final void ThrowWebLoaderException(IListener listener, String message) throws WebLoaderException
	{
		EnumSet<RuntimeOptions> currentOptions = listener.getRuntimeOptions();
		...
		if(currentOptions.contains(RuntimeOptions.THROW_EXCEPTIONS))
		{
			throw new WebLoaderException(listener, message);
		}
	}
	
	public static final void ThrowManagerException(IListener listener, String message) throws ManagerException
	{
		EnumSet<RuntimeOptions> currentOptions = listener.getRuntimeOptions();
		...
		if(currentOptions.contains(RuntimeOptions.THROW_EXCEPTIONS))
		{
			throw new ManagerException(listener, message);
		}
	}
	public static final void ThrowContentException(IListener listener, String message) throws ContentException
	{
		EnumSet<RuntimeOptions> currentOptions = listener.getRuntimeOptions();
		...
		if(currentOptions.contains(RuntimeOptions.THROW_EXCEPTIONS))
		{
			throw new ContentException(listener, message);
		}
	}
    /**
